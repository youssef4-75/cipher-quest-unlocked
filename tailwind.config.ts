	...
	theme: {
		...
		extend: {
			...
			keyframes: {
				...
				'glow': {
					'0%, 100%': { 
						textShadow: '0 0 5px rgba(155, 135, 245, 0.8), 0 0 10px rgba(155, 135, 245, 0.5)' 
					},
					'50%': { 
						textShadow: '0 0 10px rgba(155, 135, 245, 1), 0 0 20px rgba(155, 135, 245, 0.8)' 
					}
				},
				'float': {
			...
			animation: {
				...
				'matrix-bg': 'matrix-bg 30s linear infinite',
