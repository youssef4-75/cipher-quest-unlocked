    ...
    if (gameId && (gameId in games)) {
        ...
        if (passwordTentative.toLowerCase() === correctPassword.toLowerCase()) {
            ...
            if (user.currentGame[1] === game.length - 1) {
                ...
                return ['win', game.finalPassword];
            } else {
                // Move to next phase
                return ['next', game.phases[user.currentGame[1]]];
            }
        } else {
            ...
            highlighted = highlightPassword(passwordTentative, user.currentGame[2], correctPassword, game.maxAttempts);
