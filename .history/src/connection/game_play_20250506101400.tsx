...
export function getGames(gameId: string, phase: number){
...
const handleSubmit = (gameId: string, currentPhase, password, setCurrentPhase, ) => {
...
export function generateHint(gameId: string, user: string){
