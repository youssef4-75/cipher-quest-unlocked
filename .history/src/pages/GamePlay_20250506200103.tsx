...
import { generateHint, getGames, submitAnswer } from '@/connection/game_play';
                  ...
                  <div className="space-y-1">
                    {incorrectAttempts.map((attempt, index) => (
                      <div key={index} className="text-sm p-1 bg-secondary/20 rounded">
                        {highlightPassword(attempt, index, game.phase.password, game.phase.maxAttempts)}
                      </div>
                    ))}
                  </div>
                </div>
