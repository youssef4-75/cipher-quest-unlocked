        ...
        {gameStatus === "playing" ? (
          ...
          <div className="text-center p-10 cipher-card">
            ...
            <p className="mb-6">You successfully solved all the puzzles 
                and completed the game <span className="text-green-500 font-bold glow-text">{games[gameId].title}</span>.
            </p>
            <p className="mb-6">
                You achieved the password: <span className="text-blue-500 font-bold glow-text">{games[gameId].finalPassword}</span>
            </p>
