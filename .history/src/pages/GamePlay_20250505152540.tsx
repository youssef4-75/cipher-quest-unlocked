  ...
  game2: {
    ...
    phases: [
      ...
      },
      {
        ...
        messages: [
          { id: 1, text: "Computer language with snakes (", hash: 2, position: { top: 45, left: 20 } },
          { id: 2, text: "Coffee alternative (", hash: 1, position: { top: 15, left: 55 } },
          { id: 3, text: "Hot beverage herb (", hash: 3, position: { top: 70, left: 70 } }
        ],
