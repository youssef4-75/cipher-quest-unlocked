          ...
          <>
                  ...
                  <div className="space-y-1">
                    {incorrectAttempts.map((attempt, index) => (
                      <div key={index} className="text-sm p-1 bg-secondary/20 rounded">
                        {highlightPassword(attempt, index, game.phases[currentPhase].password, game.phases[currentPhase].maxAttempts)}
                      </div>
                    ))}
                  </div>
                </div>
            ...
            <div className="flex flex-col gap-4">
              <div className="flex gap-4">
                ...
                />
                <Button onClick={e => handleSubmit(gameId, )}>Submit</Button>
              </div>
