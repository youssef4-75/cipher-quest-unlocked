...
location that contains valuable information about the next challenge.`,
    phases: [
      ...
      },
      {
        ...
        messages: [
          { id: 1, text: "What lock needs", hash:  position: { top: 35, left: 45 } },
          { id: 2, text: "Good as...", hash:  position: { top: 10, left: 60 } },
          { id: 3, text: "Silver metallic element", hash:  position: { top: 70, left: 25 } },
          { id: 4, text: "Yellow fruit", hash:  position: { top: 55, left: 80 } }
        ],
