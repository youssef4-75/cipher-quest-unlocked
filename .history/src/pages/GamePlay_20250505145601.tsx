...
const ranPosGenerator = (n: number) => Math.round(Math.random() * 100
}
    ...
    phases: [
      {
        ...
        messages: [
          { id: 1, text: "Invention of writing in Sumer (Mesopotamia) (2)", position: { top: 30, left: 25 } },
          { id: 2, text: "Columbus reaches the Americas. (1)", position: { top: 65, left: 40 } },
          { id: 3, text: "French Revolution begins (3)", position: { top: 10, left: 75 } },
          { id: 4, text: "World War II (3)", position: { top: , left: 75 } },
        ],
        password: "milkbowl"
      },
      {
