    ...
    phases: [
      {
        ...
        messages: [
          { id: 1, text: "First part is 'pass' (2)", hash: 2, position: { top: 15, left: 20 } },
          { id: 2, text: "The code begins with 'cipher' (1)", hash: 1, position: { top: 60, left: 70 } },
          { id: 3, text: "Final segment is 'word' (3)", hash: 3, position: { top: 40, left: 40 } }
        ],
      ...
      },
      {
        ...
        messages: [
          { id: 1, text: "Sky color (3)", hash: 3, position: { top: 25, left: 30 } },
          { id: 2, text: "Roses are... (1)", hash: 1, position: { top: 70, left: 10 } },
          { id: 3, text: "Secret code: 123 (2)", hash: 2, position: { top: 50, left: 65 } }
        ],
        password: "red123blue"
      },
      {
    ...
    phases: [
      {
        ...
        messages: [
          { id: 1, text: "Invention of writing in Sumer (Mesopotamia) (24)", hash: 24, position: 
            { top: ranPosGenerator(100), left: ranPosGenerator(100) }
          },
          { id: 2, text: "Columbus reaches the Americas. (301)", hash: 301, position: 
            { top: ranPosGenerator(100), left: ranPosGenerator(100) } 
          },
          { id: 3, text: "French Revolution begins (4)", hash: 4, position: 
            { top: ranPosGenerator(100), left: ranPosGenerator(100) }
          },
          { id: 4, text: "World War II (23)", hash: 23, position: 
            { top: ranPosGenerator(100), left: ranPosGenerator(100) } 
          },
          { id: 5, text: "COVID-19 pandemic begins. (102)", hash: 102, position: 
            { top: ranPosGenerator(100), left: ranPosGenerator(100) } 
          },
        ],
      ...
      },
      {
        ...
        messages: [
          { id: 1, text: "Computer language with snakes (2)", hash: 2, position: { top: 45, left: 20 } },
          { id: 2, text: "Coffee alternative (1)", hash: 1, position: { top: 15, left: 55 } },
          { id: 3, text: "Hot beverage herb (3)", hash: 3, position: { top: 70, left: 70 } }
        ],
            ...
            >
              {game.phases[currentPhase].messages.map((message) => (
                ...
                >
                  ...
                  {message.text}
                  <div className="bg-green">{message.hash}</div>
                </div>
              ))}
            </div>
