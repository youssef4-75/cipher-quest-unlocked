    ...
    phases: [
      {
        ...
        messages: [
          { id: 1, text: "First part is 'pass' (2)", hash: , position: { top: 15, left: 20 } },
          { id: 2, text: "The code begins with 'cipher' (1)", hash: , position: { top: 60, left: 70 } },
          { id: 3, text: "Final segment is 'word' (3)", hash: , position: { top: 40, left: 40 } }
        ],
      ...
      },
      {
        ...
        messages: [
          { id: 1, text: "Sky color (3)", hash: , position: { top: 25, left: 30 } },
          { id: 2, text: "Roses are... (1)", hash: , position: { top: 70, left: 10 } },
          { id: 3, text: "Secret code: 123 (2)", hash: , position: { top: 50, left: 65 } }
        ],
        password: "red123blue"
      },
      {
