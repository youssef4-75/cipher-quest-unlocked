  ...
  game2: {
    ...
    phases: [
      ...
      },
      {
        ...
        messages: [
          { id: 1, text: "Computer language with snakes (2)", hash: , position: { top: 45, left: 20 } },
          { id: 2, text: "Coffee alternative (1)", hash: , position: { top: 15, left: 55 } },
          { id: 3, text: "Hot beverage herb (3)", hash: , position: { top: 70, left: 70 } }
        ],
