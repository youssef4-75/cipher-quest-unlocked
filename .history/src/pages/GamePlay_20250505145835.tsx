    ...
    phases: [
      {
        ...
        messages: [
          { id: 1, text: "Invention of writing in Sumer (Mesopotamia) (2)", position: 
            { top: ranPosGenerator(100), left: ranPosGenerator(100) }
          },
          { id: 2, text: "Columbus reaches the Americas. (1)", position: 
            { top: ranPosGenerator(100), left: ranPosGenerator(100) } 
          },
          { id: 3, text: "French Revolution begins (3)", position: 
            { top: ranPosGenerator(100), left: ranPosGenerator(100) }
          },
          { id: 4, text: "World War II (3)", position: 
            { top: ranPosGenerator(100), left: ranPosGenerator(100) } 
          },
          { id: 5, text: "COVID-19 pandemic begins. (3)", position: 
            { top: ranPosGenerator(100), left: ranPosGenerator(100) } 
          },
        ],
        password: "24-31-4-23-102"
      },
      {
