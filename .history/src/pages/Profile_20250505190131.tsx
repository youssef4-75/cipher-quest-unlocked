...
import { sendUseDemand } from "@/connection/send_use_demand";
    ...
    <Layout title="Player Profile">
      ...
      <div className="relative z-10">
        ...
        <div className="lg:col-span-1">
          ...
          <Card className="cipher-card { id: 1, name: " Energy Refill", description: "Instantly refill 50 energy", quantity: 2, icon: "⚡" },">
