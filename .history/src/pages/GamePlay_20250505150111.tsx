    ...
    phases: [
      {
        ...
        messages: [
          ...
          { id: 2, text: "Columbus reaches the Americas. (301)", hash: , position: 
            { top: ranPosGenerator(100), left: ranPosGenerator(100) } 
          },
          { id: 3, text: "French Revolution begins (4)", hash: , position: 
            { top: ranPosGenerator(100), left: ranPosGenerator(100) }
          },
          { id: 4, text: "World War II (23)", hash: , position: 
            { top: ranPosGenerator(100), left: ranPosGenerator(100) } 
          },
          { id: 5, text: "COVID-19 pandemic begins. (102)", hash: , position: 
            { top: ranPosGenerator(100), left: ranPosGenerator(100) } 
          },
        ],
