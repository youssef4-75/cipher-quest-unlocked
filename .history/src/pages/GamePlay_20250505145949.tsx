...
const games = {
  ...
  game2: {
    ...
    phases: [
      {
        description: "write the right order of the given number with a minus sign separator (1-2-3-4",
        messages: [
          { id: 1, text: "Invention of writing in Sumer (Mesopotamia) (24)", position: 
            { top: ranPosGenerator(100), left: ranPosGenerator(100) }
          },
          { id: 2, text: "Columbus reaches the Americas. (301)", position: 
            { top: ranPosGenerator(100), left: ranPosGenerator(100) } 
          },
          { id: 3, text: "French Revolution begins (4)", position: 
            { top: ranPosGenerator(100), left: ranPosGenerator(100) }
          },
          { id: 4, text: "World War II (23)", position: 
            { top: ranPosGenerator(100), left: ranPosGenerator(100) } 
          },
          { id: 5, text: "COVID-19 pandemic begins. (102)", position: 
            { top: ranPosGenerator(100), left: ranPosGenerator(100) } 
          },
        ],
