        ...
        {gameStatus === "playing" ? (
          ...
          <div className="text-center p-10 cipher-card">
            ...
            <p className="mb-6">You successfully solved all the puzzles 
                and completed the game <span className="font-bold glow-text text-green-30">{games[gameId].title}</span>.
            </p>
            <p className="mb-6">
                You achieved the password: <span className="font-bold glow-text text-blue-30">{games[gameId].finalPassword}</span>
            </p>
