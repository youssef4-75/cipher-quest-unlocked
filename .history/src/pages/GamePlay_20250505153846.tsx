...
const games = {
  game1: {
    ...
    difficulty: "Easy",
    detailedDescription: `
This challenge tests your knowledge of history and your ability to decipher hidden chronological patterns. Pay close attention to the numerical clues—they hold the key to arranging these events in their true historical sequence. Solving this puzzle will unlock a forgotten chapter of the past, revealing crucial insights for your next mission. Only those who can correctly order these events will discover the secret that bridges ancient wisdom with modern understanding.
`,
    phases: [
      {
      ...
      },
      {
        ...
        messages: [
          { id: 1, text: "What lock needs", position: { top: 35, left: 45 } },
          { id: 2, text: "Good as...", position: { top: 10, left: 60 } },
          { id: 3, text: "Silver metallic element", position: { top: 70, left: 25 } },
          { id: 4, text: "Yellow fruit", position: { top: 55, left: 80 } }
        ],
