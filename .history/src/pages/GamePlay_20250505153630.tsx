...
const games = {
  game1: {
    ...
    difficulty: "Easy",
    detailedDescription: `
    This game challenges your ability to decode and rearrange hidden messages. Pay close attention to the numbers in parentheses, as they indicate the order of words in the final password. Solving this puzzle will lead you to a hidden location that contains valuable information about the next challenge.`,
    phases: [
      {
